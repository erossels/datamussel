...
cols <- ncol(tabla_all_mes)
tabla_all_mes %>% 
  kbl(caption= "Detalle materia primas - Acumulado",digits=1, format.args=list(big.mark = ','),col.names = c('Propietario', 'Indicadores', "Total", "Promedio","Total", "Promedio","Total", "Promedio", "N Empresas" ),align = "c")  %>%
  kable_paper(bootstrap_options = "striped", full_width = F, position='left',font_size = 11, html_font='Arial') %>% 
  column_spec(1, bold = T, border_right = T, border_left = T) %>%
  column_spec(2, bold = T, border_right = T) %>% 
...
cols <- ncol(tabla_all_mes)
tabla_all_mes %>% 
  kbl(caption= "Detalle materia primas - Mes actual",digits=1, format.args=list(big.mark = ','),col.names = c("Producto", "Calibre", "Total", "Promedio","Total", "Promedio","Total", "Promedio", "N Empresas"),align = "c")  %>%
  kable_paper(bootstrap_options = "striped", full_width = F, position='left',font_size = 11, html_font='Arial') %>% 
  column_spec(1, bold = T, border_right = T, border_left = T) %>%
  column_spec(2, bold = T, border_right = T) %>% 
  column_spec(4, bold = T, border_right = T) %>% 
...
cols <- ncol(tabla2)
tabla2 %>% 
  kbl(caption= paste("Detalle Indicadores Dotación"), digits=1, format.args=list(big.mark = ','), col.names= c(py$empresa) ,align = "c")  %>%
  kable_paper(bootstrap_options = "striped", full_width = F, position='left',font_size = 11, html_font='Arial') %>% column_spec(1, bold = T, border_right = T, border_left = T) %>%
  column_spec(2, bold = T, border_right = T) %>%
  row_spec(0, bold = T, color = "white", background = "#092A30" ) %>% 
  row_spec(rows, extra_css = "border-bottom: 1px solid" )
...
cols <- ncol(tabla2)
tabla2 %>% 
  kbl(caption= paste("Carne granel - Semana ", py$semana), digits=1, format.args=list(big.mark = ','), col.names=c("Indice USD/KG", "Cantidad", "Distribución","N Empresas"),align = "c")  %>%
  kable_paper(bootstrap_options = "striped", full_width = F, position='left',font_size = 11, html_font='Arial') %>% column_spec(1, bold = T, border_right = T, border_left = T) %>%
  column_spec(cols+1, border_right = T) %>%
  row_spec(0, bold = T, color = "white", background = "#092A30" ) %>% 
...
cols <- ncol(tabla2)
tabla2 %>% 
  kbl(caption= paste("Entero - Semana ", py$semana), digits=1, format.args=list(big.mark = ','), col.names=c("Indice USD/KG", "Cantidad", "Distribución", "N Empresas"), align = "c")  %>%
  kable_paper(bootstrap_options = "striped", full_width = F, position='left',font_size = 11, html_font='Arial') %>% column_spec(1, bold = T, border_right = T, border_left = T) %>%
  column_spec(cols+1, border_right = T) %>%
  row_spec(0, bold = T, color = "white", background = "#092A30" ) %>% 
  row_spec(rows-1, extra_css = "border-top: 1px solid" ) %>% 
