def ingresos_totales_empresa(empresa = 'Manuelita'):
    import pandas as pd
...
def ingresos_totales_industria():
    import pandas as pd
    import seaborn as sns
    import numpy as np
...
def ingresos_totales_otras(empresa = 'Manuelita'):
    import pandas as pd
    import seaborn as sns
    import numpy as np
...
def ingresos_acumulado(empresa = 'Manuelita'):
    import pandas as pd
    import numpy as np
...
def ingresos_mes(empresa = 'Manuelita', mes = 'Ene'):
    import pandas as pd
    import numpy as np
...
def grafico_MMPP_origen_emp(empresa = 'Manuelita'):
    import pandas as pd
    import numpy as np
...
def grafico_MMPP_Bruta_emp(empresa = 'Manuelita'):
    import pandas as pd
    import numpy as np
...
def grafico_unidades_por_kilo(empresa = 'Manuelita'):
    import pandas as pd
    import numpy as np
...
def grafico_rechazo_origen(empresa):
    import pandas as pd
    import numpy as np
...
def resumen_mensual_producto(empresa = 'Manuelita'):
    import pandas as pd
    import numpy as np
...
def resumen_mensual_otras(empresa = 'Manuelita'):
...
def detalle_productos(empresa = 'Manuelita'):
...
def detalle_productos_mes(empresa = 'Manuelita', mes = 'Ene'):
...
def resumen_dotacion_industria():
    ...
    contador.drop(2021, axis=0, inplace=True)
...
def resumen_dotacion_empresa(empresa = 'Manuelita'):
...
def resumen_dotacion_otras(empresa = 'Manuelita'):
    import pandas as pd
    import numpy as np
...
def detalle_dotacion_mensual(empresa = 'Manuelita', mes= 'Ene'):
    import pandas as pd
    import numpy as np
    idx = pd.IndexSlice
...
def detalle_dotacion_areas(empresa = 'Manuelita', mes = 'Ene'):
    import pandas as pd
    import numpy as np
    idx = pd.IndexSlice
...
def detalle_dotacion_mes(empresa = 'Manuelita', mes = 'Ene'):
    import pandas as pd
    import numpy as np
    idx = pd.IndexSlice
...
def precios_carne_granel(semana = 32):
    import pandas as pd
    import numpy as np
    idx = pd.IndexSlice
    ...
    tabla_precio = precios[precios.SEMANA == semana].groupby(['PRODUCTO EQUIVALENTE','CALIBRE'])[['PRECIO EQUIV.','CANTIDAD','EMPRESA']].agg({'PRECIO EQUIV.': np.mean, 'CANTIDAD': np.sum, 'EMPRESA':lambda x: len(x.unique())})
...
def precios_carne_retail(semana = 32):
    import pandas as pd
    import numpy as np
    idx = pd.IndexSlice
...
def precios_entero(semana = 32):
    ...
    tabla_precio = precios[precios.SEMANA == semana].groupby(['PRODUCTO EQUIVALENTE','MERCADO'])[['PRECIO EQUIV.','CANTIDAD', 'EMPRESA']].agg({'PRECIO EQUIV.': np.mean, 'CANTIDAD': np.sum, 'EMPRESA': lambda x: len(x.unique())})
...
def precios_entero_con_salsa(semana = 32):
    import pandas as pd
    import numpy as np
    idx = pd.IndexSlice
...
def grafico_toneladas_semanas_carne_entero():
    import pandas as pd
    import numpy as np
    idx = pd.IndexSlice
...
def grafico_precios_semanas_carne_calibre():
    import pandas as pd
    import numpy as np
    idx = pd.IndexSlice
...
def grafico_precios_semanas_carne_retail():
    import pandas as pd
    import numpy as np
    idx = pd.IndexSlice
...
def grafico_toneladas_semanas_tipos():
    import pandas as pd
    import numpy as np
    idx = pd.IndexSlice
